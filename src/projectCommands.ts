 ...
 * {@link shellQuote}/{@link shellQuoteRemotePath} — see ./shellQuote.ts.
 *
 * Wrap the result in `pathAwareCommand` (./aplexerCommands.ts) before
...
import type { ReposCloneOptions } from './transport';

export type { ReposCloneOptions };
